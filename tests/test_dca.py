...
def test_dca_is_logged_and_finite():
    ...
    pid=entry.order.position_id;result=service.dca(pid,request(OrderType.DCA,position_id=pid),quote=QUOTE,market_regime="TRENDING",structure_state="VALID",risk_state="ALLOWED",data_quality="VALID",provider_status="ONLINE",prediction=PRED)
