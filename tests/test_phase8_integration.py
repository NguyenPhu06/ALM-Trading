...
def test_market_intelligence_nn_strategy_risk_paper_dca_exit_journal_performance_flow():
    ...
    assert service.dca(pid,request(OrderType.DCA,position_id=pid),quote=QUOTE,market_regime="TRENDING",structure_state="HL_VALID",risk_state="ALLOWED",data_quality="VALID",provider_status="ONLINE",prediction=PRED).accepted
